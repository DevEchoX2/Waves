  ...
  function closeTab(tId) {
    if (bTabs.length === 1) {
      showToast("error", "Cannot close last tab!", "x-circle");
      return;
    }
  ...
  async function launchEruda() {
    showToast("info", "Launching Eruda...", "zap");
    try {
      eruda.init();
      showToast("success", "Successfully injected Eruda", "check-circle");
    } catch (e) {
      showToast("error", "Failed to inject Eruda", "x-circle");
    }
  }
  ...
  async function fixProxy() {
    ...
    showToast("success", "Connection reset to Libcurl!", "refresh-cw")
    console.log(
    ...
    showToast("success", "Service workers reregistered. (1/2)", "check-circle");
    console.log(
    ...
    showToast("success", "Service workers reregistered. (2/2)", "check-circle");
    console.log(
